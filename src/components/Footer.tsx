        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-6 md:mb-8">
          ...
          <div>
            ...
            <div className="flex space-x-3 md:space-x-4">
              <a
                href="https://www.linkedin.com/company/imc-labs-cl/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-[#0077b5] rounded-full flex items-center justify-center hover:bg-[#0a66c2] transition-colors duration-200"
                aria-label="LinkedIn"
              >
